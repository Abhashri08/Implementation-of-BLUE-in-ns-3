...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set QueueDisc type to PfifoFast or BLUE", queueDiscType);
  ...
  if ((queueDiscType != "BLUE") && (queueDiscType != "PfifoFast"))
    {
      NS_ABORT_MSG ("Invalid queue disc type: Use --queueDiscType=BLUE or --queueDiscType=PfifoFast");
    }
  ...
  Config::SetDefault ("ns3::BlueQueueDisc::PMark", DoubleValue (0.2));
